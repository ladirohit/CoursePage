...
<p></p>
<h2 ><b>Slot: <b style="color:white;">G2</b></b></h2>
  		...
  		<div id="login-right">
  			...
  			<div class="w-100">
  				<h4 class="text-success text-center"><b>Create Account in E-Learning Course Page System </b></h4>
  				<br>
 ...
 <select name="X" id="X" class="form-control">
    ...
    <option value="saab">Faculty</option>
  						...
  						<div class="form-group">
  							<label for="username" class="control-label text-success">Enter name: </label>
  							<input type="text" id="username" name="username" class="form-control">
  						</div>
  						<div class="form-group">
  							<label for="password" class="control-label text-success">Enter University name:</label>
  							<input type="password" id="password" name="password" class="form-control">
  						</div>
  						<div class="form-group">
  							<label for="password" class="control-label text-success">Enter department:</label>
  							<input type="password" id="password" name="password" class="form-control">
  						</div>
  						<div class="form-group">
  							<label for="username" class="control-label text-success">Create Username</label>
  							<input type="text" id="username" name="username" class="form-control">
  						</div>
  						<div class="form-group">
  							<label for="password" class="control-label text-success">Create Password</label>
  							<input type="password" id="password" name="password" class="form-control">
  						</div>

  				<div class="form-group">
  							<label for="password" class="control-label text-success">Retype Password</label>
  							<input type="password" id="password" name="password" class="form-control">
  						</div>
  						
  						<center><button class="btn-sm btn-block btn-wave col-md-4 btn-success">Create Account</button></center>
